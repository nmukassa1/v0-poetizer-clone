...
export function PieceCard({ post }: { post: V4PiecePost }) {
  ...
  return (
    <article className="border-b border-[var(--v5-border-soft)] py-10 first:pt-6 min-[480px]:py-12 lg:py-14">
      <div className="mx-auto max-w-2xl lg:max-w-none">
        <div className="mb-6 flex items-center gap-3 min-[480px]:mb-8">
          <span className="h-px flex-1 bg-[var(--v5-border)]" />
          <Tag label={post.type} />
          <span className="h-px flex-1 bg-[var(--v5-border)]" />
        </div>

        <h2 className="mb-6 font-serif text-2xl font-medium leading-tight tracking-tight text-[var(--v5-fg)] min-[480px]:mb-8 min-[480px]:text-3xl lg:text-4xl">
          {post.title}
        </h2>

        <div className="mb-6 space-y-2 font-serif text-base leading-relaxed text-[var(--v5-fg)]/90 min-[480px]:mb-8 min-[480px]:text-lg min-[480px]:leading-[1.75] lg:text-xl">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 border-t border-[var(--v5-border)] pt-5 min-[480px]:pt-6">
          ...
          <div className="flex items-center gap-4 min-[480px]:gap-5">
            <button
              type="button"
              className="group flex items-center gap-2 text-[var(--v5-subtle)] transition-colors hover:text-[#534AB7]"
            >
              <Heart
            ...
            <button
              type="button"
              className="flex items-center gap-2 text-[var(--v5-subtle)] transition-colors hover:text-[#534AB7]"
            >
              <MessageCircle
