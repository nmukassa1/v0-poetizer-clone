...
export interface V4PromptSubmission {
  title: string
  author: string
  type: ContentTag
  likes: number
...
export interface V4WeeklyPrompt {
  title: string
  count: number
  days: number
  submissions: V4PromptSubmission[]
}

export interface V4SocialPost {
  kind: "social"
  author: string
  handle: string
  time: string
...
export type V4FeedItem = V4SocialPost | V4PiecePost

export type V4Filter = "all" | "pieces" | "posts" | "poems" | "stories"

export const v4Featured: V4Featured = {
  type: "poem",
  date: "May 21",
...
export const v4WeeklyPrompt: V4WeeklyPrompt = {
...
export const v4FeedItems: V4FeedItem[] = [
  {
    kind: "social",
    author: "Sofia Chen",
    handle: "sofiac",
...
export const v4TrendingWriters = [
...
export const v4QuoteOfDay = {
  text: "The first draft is just you telling yourself the story.",
  author: "Terry Pratchett",
}

export function filterV4Feed(items: V4FeedItem[], filter: V4Filter): V4FeedItem[] {
